...
app.add_middleware(
    ...
    allow_origin_regex=r"https://.*\.vercel\.app",  # Allow all Vercel domains (production and preview)
...
from .api import webhook, registrations, analytics

# Auth disabled for now - will use external auth service later
